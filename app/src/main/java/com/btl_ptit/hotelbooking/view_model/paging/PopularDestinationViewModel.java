...
public class PopularDestinationViewModel extends ViewModel {
    public Flowable<PagingData<MyPopularDestination>> pagingDataFlow;
    private MyDestinationRepository repository;
    ...
    public PopularDestinationViewModel(MyDestinationRepository repository) {
        this.repository = repository;
        initPaging();
    }

    private void initPaging() {
        Flowable<PagingData<MyPopularDestination>> flowable = repository.getDestinationsPaging();
